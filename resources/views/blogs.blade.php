    ...
    <div class="grid grid-cols-1 px-auto sm:px-12 md:grid-cols-4 mt-20 mb-20 justify-center">
        <div class="md:col-span-3 grid grid-cols-1 sm:grid-cols-2 mx-10">
            @forelse($journals as $journal)
                <div
                    class="ml-5 bg-gray-50 border border-gray-200 rounded-lg shadow
            dark:bg-gray-700 dark:border-gray-700 mt-5 relative self-center delay-tran">
                    <a href="#">
                        <img class="rounded-t-lg object-cover w-full h-40"
                            src="https://www.cleverfiles.com/howto/wp-content/uploads/2018/03/minion.jpg" alt="Cat Image" />
                    </a>
                    <div class="p-3 flex flex-col h-40">
                        <a href="/journal/{{ $journal->id }}">
                            <h6
                                class="break-words mb-2 text-xl font-semibold tracking-tight
        ...
        <div class="md:col-span-1">
            <div
                class="border mt-5 w-full max-w-md p-4 rounded-lg sm:px-8 bg-gray-50
             border-gray-200 shadow dark:bg-gray-700 dark:border-gray-700
              relative self-center delay-tran">
                <div class="flex items-center justify-center mb-4">
                    <h6
                        class="text-1xl font-semibold leading-none text-gray-900 
                    dark:text-white delay-tran">
                        New Authors</h6>
