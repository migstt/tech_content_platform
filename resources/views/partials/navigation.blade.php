<nav class="relative px-10 py-4 flex justify-between items-center bg-white border-solid" id="navbar">
    <a class="text-3xl font-bold leading-none mx-20" href="#">
    ...
    <ul
        ...
        <li><a class="text-l text-green-700 font-semibold hover:text-green-900" href="/">Home</a></li>
        ...
        <li>
            <a class="text-l text-gray-500 font-semibold" href="#">About</a>
        </li>
    ...
    <div class="relative ml-3 flex items-center mr-10">
        {{-- PROFILE PICTURE and CREATE JOURNAL WITH DROPDOWN FOR AUTHENTICATED USERS --}}
        @auth
            <a href="{{ route('create') }}">
                <button id="user-menu-button" type="button"
                    class="mr-5 text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4
                        focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5
                        text-center inline-flex items-center dark:focus:ring-[#4285F4]/55">
                    Publish somethings
                </button>
            </a>
        @endauth
