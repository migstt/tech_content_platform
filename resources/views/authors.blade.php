...
<body class="blogs-section bg-white dark:bg-gray-900">
    ...
    <div class="mt-4 mx-20 flex grid grid-cols-4 gap-4 content-center">

        @forelse($authors as $author)
            <figure
                class="flex flex-col items-center justify-center p-4 text-center bg-white border-b border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-tl-lg md:border-r dark:bg-gray-800 dark:border-gray-700">
